...
void _MD5Init (MD5_CTX *context)                                       /* context */
{
 ...
 * context.
 */
void _MD5Update (MD5_CTX *context, unsigned char *input,unsigned int inputLen) /* length of input block */
{
 ...
 */
void _MD5Final (unsigned char digest[16], MD5_CTX *context)
{
...
void MD5(unsigned char strInputString[], unsigned char md5Digest[], unsigned int len){
	...
	_MD5Update(&ctx, strInputString, len);
	_MD5Final(md5Digest, &ctx);
}